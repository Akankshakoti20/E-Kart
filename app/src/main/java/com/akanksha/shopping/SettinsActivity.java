...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        ref.child(Prevalent.currentOnlineUser.getPhone().toString()).updateChildren(userMap);
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone().toString());
